...
public class JsonAdaptedTuteeTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedTutee tutee =
                new JsonAdaptedTutee(INVALID_NAME, VALID_PHONE, VALID_LEVEL, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedTutee tutee = new JsonAdaptedTutee(null, VALID_PHONE, VALID_LEVEL, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        JsonAdaptedTutee tutee =
                new JsonAdaptedTutee(VALID_NAME, INVALID_PHONE, VALID_LEVEL, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedTutee tutee = new JsonAdaptedTutee(VALID_NAME, null, VALID_LEVEL, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_invalidLevel_throwsIllegalValueException() {
        JsonAdaptedTutee tutee =
                new JsonAdaptedTutee(VALID_NAME, VALID_PHONE, INVALID_LEVEL, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullLevel_throwsIllegalValueException() {
        JsonAdaptedTutee tutee = new JsonAdaptedTutee(VALID_NAME, VALID_PHONE, null, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedTutee tutee =
                new JsonAdaptedTutee(VALID_NAME, VALID_PHONE, VALID_LEVEL, INVALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedTutee tutee = new JsonAdaptedTutee(VALID_NAME, VALID_PHONE, VALID_LEVEL, null, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedTutee tutee =
                new JsonAdaptedTutee(VALID_NAME, VALID_PHONE, VALID_LEVEL, VALID_ADDRESS, invalidTags);
