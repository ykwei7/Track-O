...
//                Phone.MESSAGE_CONSTRAINTS); // invalid lesson index
    ...
    public void parse_setPaymentDateCommand_success() throws ParseException {
        ...
        LocalDate PAYMENT_DATE_AMY = ParserUtil.parsePayByDate(VALID_PAYMENT_DATE_AMY);
...
//    }
    ...
    public void parse_receivePaymentCommand_success() throws ParseException {
        ...
        LocalDate PAYMENT_RECV_DATE_AMY = ParserUtil.parsePayByDate(VALID_PAYMENT_RECV_DATE_AMY);
        PaymentCommand expectedCommand = new PaymentReceiveCommand(targetIndex, PAYMENT_RECV_DATE_AMY);
        assertParseSuccess(parser, userInput, expectedCommand);
    }
